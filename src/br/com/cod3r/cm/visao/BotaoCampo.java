...
import static br.com.cod3r.cm.modelo.CampoEvento.ABRIR;
import static br.com.cod3r.cm.modelo.CampoEvento.MARCAR;

public class BotaoCampo extends JButton implements CampoObservador {

    private final Color BG_PADRAO = new Color(184, 184, 184);
    private final Color BG_MARCAR = new Color(8, 8, 247);
